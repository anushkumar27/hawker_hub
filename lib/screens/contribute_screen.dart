                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      FormBuilderTextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () {
                                _formKey.currentState!.fields['hub_name']
                                    ?.reset();
                              },
                            )),
                        onChanged: (val) {
                          setState(() {
                            _hubNameHasError = !(_formKey
                                    .currentState?.fields['hub_name']
                                    ?.validate() ??
                                false);
                          });
                        },
                      ...
                      FormBuilderTextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              icon: const Icon(Icons.close),
                              onPressed: () {
                                _formKey.currentState!.fields['hub_description']
                                    ?.reset();
                              },
                            )),
                        onChanged: (val) {
                      ...
                      FormBuilderDropdown<String>(
                        ...
                        onChanged: (val) {
                          setState(() {
                            _hubCategoryOptionsHasError = !(_formKey
                                    .currentState?.fields['hub_category']
                                    ?.validate() ??
                                false);
                          });
                        },
                      ...
                      FormBuilderTextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              icon: const Icon(Icons.close),
                              onPressed: () {
                                _formKey.currentState!.fields['hub_cost']
                                    ?.reset();
                              },
                            )),
                        onChanged: (val) {
                          setState(() {
                            _hubCostHasError = !(_formKey
                                    .currentState?.fields['hub_cost']
                                    ?.validate() ??
                                false);
                          });
                        },
                      ...
                      FormBuilderTextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              icon: const Icon(Icons.close),
                              onPressed: () {
                                _formKey.currentState!.fields['hub_address']
                                    ?.reset();
                              },
                            )),
                        onChanged: (val) {
                          setState(() {
                            _hubAddressHasError = !(_formKey
                                    .currentState?.fields['hub_address']
                                    ?.validate() ??
                                false);
                          });
                        },
                      ...
                      FormBuilderDateTimePicker(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              icon: const Icon(Icons.close),
                              onPressed: () {
                                _formKey.currentState!.fields['hub_start_time']
                                    ?.reset();
                              },
                            )),
                      ),
                      ...
                      FormBuilderDateTimePicker(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              icon: const Icon(Icons.close),
                              onPressed: () {
                                _formKey.currentState!.fields['hub_end_time']
                                    ?.reset();
                              },
                            )),
                      ),
